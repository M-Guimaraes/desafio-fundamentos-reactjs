  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const balanceFormatted = {
        income: formatValue((await response).data.balance.income),
        outcome: formatValue((await response).data.balance.outcome),
        total: formatValue((await response).data.balance.total),
      };
